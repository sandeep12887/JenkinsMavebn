...
public class Stepdefinition_Adactin extends Base_Adactin {
	...
	inputValuestoWebelement(pom.getLp().getUsername_input(),PropertyReaderManager.getInstance().getPr().getusername());
	inputValuestoWebelement(pom.getLp().getPassword_input(), PropertyReaderManager.getInstance().getPr().getpassword());
   ...
   @Then("^User should enter the no of Adults \"([^\"]*)\" and number of childrens \"([^\"]*)\"$")
	public void user_should_enter_the_no_of_Adults_and_number_of_childrens(String adults, String child) throws Throwable {
  ...
  /* @Then("^User should verify that search location shuold be exactly match with next page of select hotel location$")
	public void user_should_verify_that_search_location_shuold_be_exactly_match_with_next_page_of_select_hotel_location() throws Throwable {
   String compare = pom.getsh().getLocationname().getText();
...
public void verify_the_selected_checkin_date_is_match_with_nextpage() throws Throwable {
	String datein = pom.getsh().getDateincompare().getText();
...
public void verify_the_selected_checkout_date_is_match_with_nextpage() throws Throwable {
	String dateOUT = pom.getsh().getDateoutcompare().getText();
  ...
  @When("^User should click the Booked Itinerary button$")
   ...
   public void user_verify_that_order_number_is_cancelled_and_now_longer_exists_in_Booked_Itinerary_page() throws Throwable {
